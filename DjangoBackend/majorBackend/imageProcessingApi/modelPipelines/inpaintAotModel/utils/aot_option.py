...
# data specifications
# parser.add_argument("--dir_image", type=str, default=r"D:\bachelor\major\scratch-detection\Load and Test model\resized_swin_image", help="image dataset directory")
# parser.add_argument("--dir_mask", type=str, default=r"D:\bachelor\major\scratch-detection\Load and Test model\output_masks", help="mask dataset directory")
...
parser.add_argument("--model", type=str, default="pretrained_aot1", help="model name")
...
parser.add_argument("--lrg", type=float, default=1e-4, help="learning rate for generator")
parser.add_argument("--lrd", type=float, default=1e-4, help="learning rate for discriminator")
parser.add_argument(
    "--optimizer", default="ADAM", choices=("SGD", "ADAM", "RMSprop"), help="optimizer to use (SGD | ADAM | RMSprop)"
)
...
parser.add_argument("--pre_train", type=str, default=MODEL_PATHS["aot_generator"], help="path to pretrained models")
parser.add_argument("--outputs", type=str, default=r"D:\bachelor\major\scratch-detection\Load and Test model\output", help="path to save results")
parser.add_argument("--thick", type=int, default=20, help="the thick of pen for free-form drawing")
