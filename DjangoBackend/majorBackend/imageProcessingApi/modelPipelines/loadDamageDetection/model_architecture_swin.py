...
# -------------------------
# Window Partition/Reverse Functions
# -------------------------
...
# -------------------------
# Basic Encoder and Decoder Layers
# -------------------------
class BasicLayer(nn.Module):
    ...
    def forward(self, x):
        ...
        x_before_downsample = x  # Store x before downsampling
...
# -------------------------
# Swin Transformer System (Encoder + Decoder)
# -------------------------
class SwinTransformerSys(nn.Module):
    r"""Swin-Unet for damage detection.
       Modified for input image size of 512 and output channels of 512.
    """
    def __init__(self, img_size=512, patch_size=4, in_chans=3, num_classes=512,
        ...
        super().__init__()
        print(f"SwinTransformerSys init: depths:{depths}; depths_decoder:{depths_decoder}; drop_path_rate:{drop_path_rate}; num_classes:{num_classes}")
        ...
        for i_layer in range(self.num_layers):
            # Define the concatenation layer (if needed)
